...
export default function AccountError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center px-4">
      <h2 className="text-xl font-semibold mb-2">Could not load your account</h2>
      <p className="text-muted-foreground mb-6">We had trouble loading your account information.</p>
